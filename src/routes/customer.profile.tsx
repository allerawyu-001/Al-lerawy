...
function ProfilePage() {
  ...
  if (authLoading) return <DashboardLayout role="customer" title="Profile"><div className="flex justify-center py-12"><Loader2 className="h-5 w-5 animate-spin" /></div></DashboardLayout>;
